...
name = "Sana"
grade = 11
favourite_exclamation = "wow!"
least_favourite_colour = "orange"
is_cool = "absolutely"
math_test_score = 89
sister_name = "Ayla"
school = "Father Michael Goetz Secondary School"
new_test_score = 95
course = "math"
...
# Processing / Output
print( f"Hey guys, my name is {name} and I am currently in grade {grade}. I go to {school}."
    ...
    + f"Anyway, that's the story of my math test."
    + f"I hope I get {new_test_score} on my next test because is will increase my mark in {course} "